...
export let smartPlan: SmartPlan | null = null;
export let smartPlanFor: string | null = null;
...
export let smartLookupFor: string | null = null;
...
function smartBusy(busy: boolean, message?: string) {
