...
#
# 0.1.0 is an unsigned test build, so Gatekeeper blocks it until you run
#   xattr -dr com.apple.quarantine /Applications/Wisp.app
# The next signed release replaces both lines below and removes that step.
cask "wisp" do
  version "0.1.0"
  sha256 "0c3dd9b1f666fea527eb6fcf2f8ac5120ccbff0f6e50b0df8645634db2d19ddd"
