...
function buildInsertPrompt(files: GatheredFile[], text: string, currentRel: string | null) {
  let filesSection;
  if (!files.length) {
...
function buildLookupPrompt(files: GatheredFile[], question: string, currentRel: string | null) {
  let filesSection;
  if (!files.length) {
...
function buildImagePrompt(rel: string) {
  return [
